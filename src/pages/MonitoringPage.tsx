    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Live data from Thermal Battery Unit 1</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        <div className="bg-gradient-to-br from-red-500 to-orange-600 rounded-xl shadow-lg p-6 text-white">
          ...
          <p className="text-sm opacity-90 mb-1">{t('monitoring.temperature')}</p>
          <p className="text-4xl font-bold">{systemStatus.temperature.toFixed(0)}°C</p>
        ...
        <div className="bg-gradient-to-br from-blue-500 to-cyan-600 rounded-xl shadow-lg p-6 text-white">
          ...
          <p className="text-sm opacity-90 mb-1">{t('monitoring.pressure')}</p>
          <p className="text-4xl font-bold">{systemStatus.pressure.toFixed(1)} bar</p>
        ...
        <div className="bg-gradient-to-br from-purple-500 to-pink-600 rounded-xl shadow-lg p-6 text-white">
          ...
          <p className="text-sm opacity-90 mb-1">{t('monitoring.flowRate')}</p>
          <p className="text-4xl font-bold">{systemStatus.flowRate.toFixed(0)}</p>
        ...
        <div className="bg-gradient-to-br from-yellow-500 to-amber-600 rounded-xl shadow-lg p-6 text-white">
          ...
          <p className="text-sm opacity-90 mb-1">{t('monitoring.power')}</p>
          <p className="text-4xl font-bold">{Math.abs(systemStatus.power).toFixed(0)}</p>
        ...
        <div className="bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl shadow-lg p-6 text-white">
          ...
          <p className="text-sm opacity-90 mb-1">{t('monitoring.status')}</p>
          <p className="text-2xl font-bold capitalize">{systemStatus.status}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
          <h3 className="text-lg font-bold text-brown-900 mb-4">Temperature Trends (24h)</h3>
        ...
        {/* Pressure Chart */}
        <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
          <h3 className="text-lg font-bold text-brown-900 mb-4">Pressure Trends (24h)</h3>
          <ResponsiveContainer width="100%" height={250}>
            <LineChart data={chartData}>
              <CartesianGrid strokeDasharray="3 3" stroke="#f0f0f0" />
              <XAxis dataKey="time" stroke="#888" fontSize={12} />
        ...
        {/* Flow Rate Chart */}
        <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
          <h3 className="text-lg font-bold text-brown-900 mb-4">Flow Rate Trends (24h)</h3>
          <ResponsiveContainer width="100%" height={250}>
            <LineChart data={chartData}>
              <CartesianGrid strokeDasharray="3 3" stroke="#f0f0f0" />
              <XAxis dataKey="time" stroke="#888" fontSize={12} />
        ...
        {/* Power Chart */}
        <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
          <h3 className="text-lg font-bold text-brown-900 mb-4">Power Trends (24h)</h3>
          <ResponsiveContainer width="100%" height={250}>
            <LineChart data={chartData}>
              <CartesianGrid strokeDasharray="3 3" stroke="#f0f0f0" />
              <XAxis dataKey="time" stroke="#888" fontSize={12} />
      ...
      {/* System Info */}
      <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
        <h3 className="text-lg font-bold text-brown-900 mb-4">System Information</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            <p className="text-sm text-gray-600 mb-1">System ID</p>
            <p className="text-lg font-semibold text-brown-900">{systemStatus.id}</p>
          </div>
          <div>
            <p className="text-sm text-gray-600 mb-1">System Name</p>
            <p className="text-lg font-semibold text-brown-900">{systemStatus.name}</p>
          </div>
          <div>
