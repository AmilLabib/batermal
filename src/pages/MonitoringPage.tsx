    ...
    <div className="space-y-4 md:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          ...
          <p className="text-sm sm:text-base text-gray-600 mt-1">Live data from Thermal Battery Unit 1</p>
        </div>
        <div className="flex items-center space-x-2 px-3 sm:px-4 py-2 bg-green-100 rounded-lg border border-green-200 self-start sm:self-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 md:gap-4">
        ...
        <div className="bg-gradient-to-br from-purple-500 to-pink-600 rounded-xl shadow-lg p-4 sm:p-6 text-white">
          <div className="flex items-center justify-between mb-3 sm:mb-4">
      ...
      <div className="bg-white rounded-xl shadow-md p-4 md:p-6 border border-gray-100">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
          <div>
            <p className="text-xs sm:text-sm text-gray-600 mb-1">System ID</p>
            <p className="text-base md:text-lg font-semibold text-brown-900 break-all">{systemStatus.id}</p>
          </div>
          <div>
            <p className="text-xs sm:text-sm text-gray-600 mb-1">System Name</p>
