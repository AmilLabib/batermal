...
const DashboardPage = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Welcome Header */}
      <div className="bg-gradient-to-r from-brown-700 to-brown-900 rounded-2xl p-8 text-white shadow-xl">
        ...
        <div className="mt-4 flex items-center space-x-2">
          ...
          <span className="text-sm text-brown-200">System Online - Last update: {systemStatus.lastUpdate.toLocaleTimeString()}</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100 hover:shadow-lg transition-shadow">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className={`px-3 py-1 rounded-full text-xs font-medium border ${getStatusColor(systemStatus.status)}`}>
          ...
          <p className="text-3xl font-bold text-brown-900 mb-2">
            {systemStatus.energyStored.toFixed(0)} <span className="text-lg text-gray-500">kWh</span>
          </p>
        ...
        <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100 hover:shadow-lg transition-shadow">
          ...
          <p className="text-3xl font-bold text-brown-900">
            {systemStatus.efficiency.toFixed(1)}<span className="text-lg text-gray-500">%</span>
          </p>
        ...
        <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100 hover:shadow-lg transition-shadow">
          ...
          <p className="text-3xl font-bold text-brown-900">
            Rp 12.4<span className="text-lg text-gray-500">M</span>
          </p>
          <p className="text-xs text-gray-500 mt-2">
        ...
        <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100 hover:shadow-lg transition-shadow">
          ...
          <p className="text-3xl font-bold text-brown-900">
            145.8<span className="text-lg text-gray-500"> tons</span>
          </p>
          <p className="text-xs text-gray-500 mt-2">
            ≈ 2,340 trees planted
          </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
          <div className="flex items-center justify-between mb-6">
            ...
            <a href="/alerts" className="text-sm text-brown-600 hover:text-brown-700 font-medium">
              {t('dashboard.viewAll')}
            </a>
          </div>
