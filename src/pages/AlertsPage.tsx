    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        {unreadCount > 0 && (
          <button
            ...
            className="flex items-center space-x-2 px-4 py-2 bg-brown-700 text-white rounded-lg hover:bg-brown-800 transition-all"
          >
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        ...
        >
          ...
          <p className="text-sm">All Alerts</p>
        </button>
                      ...
                      <div className="flex items-center space-x-2">
                        {!alert.read && (
                          <button
                            ...
                            className="flex items-center space-x-1 px-3 py-1 text-brown-700 hover:bg-brown-100 rounded-lg transition-colors text-sm font-medium"
                          >
                            <Check className="w-4 h-4" />
                        ...
                        <button
                          ...
                          className="flex items-center space-x-1 px-3 py-1 text-red-700 hover:bg-red-100 rounded-lg transition-colors text-sm font-medium"
                        >
      ...
      <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
        <h2 className="text-xl font-bold text-brown-900 mb-6">Alert Preferences</h2>
