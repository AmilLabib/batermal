...
const AlertsPage = () => {
  ...
  const getAlertIcon = (type: string) => {
    switch (type) {
      ...
      default:
        return <Info className="w-6 h-6 text-brown-600" />;
    }
  };
  ...
  return (
    <div className="space-y-4 md:space-y-6">
        ...
        <button
          ...
          className={`p-3 sm:p-4 rounded-xl border-2 transition-all ${
            filter === 'all'
              ...
              : 'bg-white text-stone-700 border-stone-200 hover:border-brown-300'
          }`}
        >
        ...
        <button
          ...
          className={`p-3 sm:p-4 rounded-xl border-2 transition-all ${
            filter === 'warning'
              ...
              : 'bg-white text-stone-700 border-stone-200 hover:border-yellow-300'
          }`}
        >
      ...
      {/* Alerts List */}
      <div className="bg-white rounded-xl shadow-md border border-stone-100">
        <div className="p-4 sm:p-6 border-b border-stone-200 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <div className="divide-y divide-gray-100">
          {filteredAlerts.length === 0 ? (
            <div className="p-12 text-center">
              ...
              <p className="text-stone-500 text-lg">No alerts to display</p>
            </div>
          ) : (
            filteredAlerts.map((alert) => (
              <div
                ...
                className={`p-4 sm:p-6 transition-all ${
                  alert.read ? 'bg-white' : 'bg-brown-50/50'
                } hover:bg-stone-50`}
              >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-2 gap-2">
                      <div className="flex-1">
                        ...
                        {!alert.read && (
                          <span className="inline-block px-2 py-1 bg-brown-600 text-white text-xs font-medium rounded">
                            New
                          </span>
                        )}
                      </div>
                      <span className={`px-2 sm:px-3 py-1 rounded-full text-xs font-medium border whitespace-nowrap self-start ${
                        ...
                        alert.type === 'success' ? 'bg-amber-100 text-amber-800 border-amber-200' :
                        'bg-brown-100 text-brown-800 border-brown-200'
                      }`}>
        ...
        <div className="space-y-3 md:space-y-4">
          <div className="flex items-center justify-between p-4 bg-stone-50 rounded-lg">
            <div>
              ...
              <p className="text-sm text-stone-600">System failures, safety issues</p>
            </div>
          ...
          <div className="flex items-center justify-between p-4 bg-stone-50 rounded-lg">
            <div>
              ...
              <p className="text-sm text-stone-600">Efficiency drops, optimization opportunities</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input type="checkbox" className="sr-only peer" defaultChecked />
              <div className="w-11 h-6 bg-stone-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-brown-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-stone-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-brown-600"></div>
          ...
          <div className="flex items-center justify-between p-4 bg-stone-50 rounded-lg">
            <div>
              ...
              <p className="text-sm text-stone-600">Payment reminders, invoice notifications</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input type="checkbox" className="sr-only peer" defaultChecked />
              <div className="w-11 h-6 bg-stone-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-brown-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-stone-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-brown-600"></div>
          ...
          <div className="flex items-center justify-between p-4 bg-stone-50 rounded-lg">
            <div>
              ...
              <p className="text-sm text-stone-600">New optimization suggestions</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input type="checkbox" className="sr-only peer" defaultChecked />
              <div className="w-11 h-6 bg-stone-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-brown-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-stone-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-brown-600"></div>
