...
const Header = ({ onMenuClick }: HeaderProps) => {
  ...
  return (
    <header className="fixed top-0 left-0 lg:left-64 right-0 h-14 sm:h-16 bg-white border-b border-gray-200 shadow-sm z-30 flex items-center justify-between px-4 sm:px-6 lg:px-8">
      ...
      <div className="flex items-center space-x-2 sm:space-x-4">
        ...
        <div className="relative">
          ...
          {showLangMenu && (
            <div className="absolute right-0 mt-2 w-32 sm:w-36 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
              <button
        ...
        {/* User Profile */}
        <button className="flex items-center space-x-2 sm:space-x-3 px-2 sm:px-3 py-2 rounded-lg hover:bg-gray-100 transition-colors">
